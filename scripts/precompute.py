...
def precompute(df, json_path=None):
    ...
    print(f"     sentiment_now={sentiment_now:.2f}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--token", dest="spreadsheet_token", help="飞书 spreadsheet token（仅标记，不实际读取）")
